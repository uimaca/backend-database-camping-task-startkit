...
((select id from "COACH" where user_id = (select id from "USER" where name = '肌肉棒子')), (select id from "SKILL" where name in('重訓'))),
((select id from "COACH" where user_id = (select id from "USER" where name = 'Q太郎')), (select id from "SKILL" where name in('重訓'))),
...
where user_id = (select id from "USER" where name = '王小明') and course_id = (select id from "COURSE" where user_id = (select id from "USER" where name = '李燕容'));
...
select id, status from "COURSE_BOOKING"
...
where user_id = (select id from "USER" where name = '王小明') and course_id = (select id from "COURSE" where user_id = (select id from "USER" where name = '李燕容')) and status = '即將授課';
